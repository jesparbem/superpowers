...
function extractFrontmatter(filePath) {
    try {
        ...
        let name = '';
        let description = '';
        let readingBlockDescription = false;
        ...
        for (const line of lines) {
            ...
            if (inFrontmatter) {
                if (readingBlockDescription) {
                    const trimmed = line.trim();
                    if (trimmed) {
                        description = trimmed;
                        readingBlockDescription = false;
                    }
                    continue;
                }
 ...
 * Agents are single .md files (unlike skills which use a subdirectory/SKILL.md layout).
 *
 * @param {string} dir - Directory to search
 * @param {string} sourceType - 'personal' or 'superpowers'
 * @returns {Array<{path: string, name: string, description: string, sourceType: string}>}
 */
function findAgentsInDir(dir, sourceType) {
    const agents = [];
